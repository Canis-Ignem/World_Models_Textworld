...
The r_11 and the r_12 and the r_14 and the r_13 and the r_15 and the r_16 and the r_17 and the r_18 and the r_19 and the r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_7 and the r_6 and the r_9 and the r_10 and the r_0 and the r_8 are rooms.

Understand "study" as r_11.
The internal name of r_11 is "study".
The printed name of r_11 is "-= Study =-".
The study part 0 is some text that varies. The study part 0 is "You arrive in a study. An ordinary one. Okay, just remember what you're here to do, and everything will go great.
...
The canteen part 0 is some text that varies. The canteen part 0 is "This might come as a shock to you, but you've just come into a canteen.
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You are in a kitchen. An usual kind of place. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The spare room part 0 is some text that varies. The spare room part 0 is "Of every spare room you could have sauntered into, you had to come round an ordinary one.
...
The restroom part 0 is some text that varies. The restroom part 0 is "This is going to sound unbelievable, but you've just entered a restroom. You begin looking for stuff.
...
The shower part 0 is some text that varies. The shower part 0 is "You've stumbled into a typical room. Your mind races to think of what kind of room would be typical. And then it hits you. Of course. You're in the shower.
...
The r_11 and the r_12 and the r_14 and the r_13 and the r_15 and the r_16 and the r_17 and the r_18 and the r_19 and the r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_7 and the r_6 and the r_9 and the r_10 and the r_0 and the r_8 are rooms.
The r_11 and the r_12 and the r_14 and the r_13 and the r_15 and the r_16 and the r_17 and the r_18 and the r_19 and the r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_7 and the r_6 and the r_9 and the r_10 and the r_0 and the r_8 are privately-named.
...
Test quest0_0 with "go north / go east / go north / go west / go west / go north / go east / go south / go south / go west / go south / go west / go south / go east / go east / go north / go west / go north / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! First step, make an effort to move north. And then, make an effort to venture east. And then, make an effort to venture north. After that, attempt ".
The objective part 1 is some text that varies. The objective part 1 is "to venture west. With that over with, take a trip west. Okay, and then, attempt to venture north. Then, attempt to head east. That done, make an attempt to move south. And then, make an attempt to tra".
The objective part 2 is some text that varies. The objective part 2 is "vel south. That done, make an effort to head west. Okay, and then, travel south. Okay, and then, attempt to go to the west. Next, move south. And then, make an attempt to travel east. And then, make a".
The objective part 3 is some text that varies. The objective part 3 is "n effort to take a trip east. With that over with, head north. And then, head west. With that over with, go north. Then, attempt to go west. Following that, recover the coin from the floor of the cook".
The objective part 4 is some text that varies. The objective part 4 is "ery. Once that's all handled, you can stop!".
