...
class CommandScorer(nn.Module):
    def __init__(self, input_size, hidden_size):
        ...
        self.critic_h1    = nn.Linear(512, 256)
    ...
    def forward(self, obs, commands, **kwargs):
        ...
        memory = self.critic_h1(embedded)
...
class NeuralAgent:
    ...
    def __init__(self) -> None:
        ...
        self.model = CommandScorer(input_size=self.MAX_VOCAB_SIZE, hidden_size=256) #The input size might be removed since it is not used
